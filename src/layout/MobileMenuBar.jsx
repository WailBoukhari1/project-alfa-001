...
const MobileMenuBar = ({ toggleMenu }) => {
  return (
    <div className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between p-3 bg-white/70 dark:bg-gray-900/70 shadow-md backdrop-blur-md sm:px-6 xl:hidden">
      <div className="flex items-center gap-2 text-lg font-medium">
        <a href="index.html" className="flex items-center gap-2 text-gray-900 dark:text-white">
          <img src="assets/img/site-logo.svg" alt="Site Logo" className="w-8 h-8" />
          <span className="font-bold">XXXX</span>
        </a>
      </div>
      <button
        className="w-10 h-10 flex items-center justify-center border rounded-full bg-gray-50 dark:bg-gray-800 border-gray-300 dark:border-gray-700 shadow-sm"
        type="button"
